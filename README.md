...
CD case investigation forms, outbreak response
...
```bash
git clone https://github.com/zarishsphere/zs-ui-communicable-disease.git
cd zs-ui-communicable-disease
pnpm install
pnpm dev
```
